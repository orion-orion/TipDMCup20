...
LastEditTime: 2021-05-04 21:23:38
'''
...
if __name__ == '__main__':
    ...
    #     plt.legend()
    plt.plot(list_x[1], list_y[1], color = colors[1], label='AUC '+'Bagging+DCRN'+' = '+ str(AUCs[1]))
    #plt.plot(list_x[6], list_y[6], color = colors[6], label='AUC '+'DCRN'+' = '+ str(AUCs[6]))
